...
class RegisterForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs.update({'class': "form__input _req", 'placeholder': 'Логин'})
        self.fields['first_name'].widget.attrs.update({'class': "form__input _req", 'placeholder': 'Аркадий'})
        self.fields['last_name'].widget.attrs.update({'class': 'form__input _req', 'placeholder': 'Паровозов'})
